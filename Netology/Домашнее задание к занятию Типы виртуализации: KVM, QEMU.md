...
1. Виртуализация типа 1. Это Гипервизоры которые устанавливаются на голое железо.К примеру ESXI,XEN.  
1. Виртуализация типа 2. Это Гипервизоры которые устанавливаются поверх операционной системы.К примеру VMWARE Workstation,HYper-V.
1. 
---
